...
function buildOverviewMetricChips(entry: DashboardOverviewRow, isWeeklyCriticalWindow: boolean): OverviewMetricChip[] {
  return [
    ...
    { key: "abyss_lower", label: "深渊下层指令", current: entry.abyssLowerCurrent, total: entry.abyssLowerTotal, urgent: false },
    { key: "abyss_middle", label: "深渊中层指令", current: entry.abyssMiddleCurrent, total: entry.abyssMiddleTotal, urgent: false },
