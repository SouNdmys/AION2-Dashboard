...
export const TASK_DEFINITIONS: TaskDefinition[] = [
  ...
  },
  {
    id: "sanctum_raid",
    title: "圣域：卢德莱（挑战）",
    description: "每周挑战 4 次；若使用深渊重铸补充券，可额外增加 1 次挑战。",
    category: "副本",
    energyCost: 0,
    goldReward: 0,
    counterTargets: [{ scope: "activities", key: "sanctumRaidChallengeRemaining" }],
    allowComplete: true,
    allowUseTicket: false,
    allowSetCompleted: false,
    ticketTarget: { key: "sanctumRaidChallengeBonus", increment: 1 },
    baseCapDisplay: 4,
    useBonusDisplay: true,
  },
  {
    id: "sanctum_box",
    title: "圣域：卢德莱（开箱）",
    description: "每周开箱 2 次，每次默认消耗 80 奥德；若使用深渊重铸补充券，可额外增加 1 次开箱。",
    category: "副本",
    energyCost: 80,
    goldReward: 0,
    counterTargets: [{ scope: "activities", key: "sanctumRaidBoxRemaining" }],
    allowComplete: true,
    allowUseTicket: false,
    allowSetCompleted: false,
    ticketTarget: { key: "sanctumRaidBoxBonus", increment: 1 },
    baseCapDisplay: 2,
    useBonusDisplay: true,
  },
  {
    id: "sanctum_purify_raid",
    title: "圣域：侵蚀净化所（挑战）",
    description: "每周挑战 4 次。",
    category: "副本",
    energyCost: 0,
    goldReward: 0,
    counterTargets: [{ scope: "activities", key: "sanctumPurifyChallengeRemaining" }],
    allowComplete: true,
    allowUseTicket: false,
    allowSetCompleted: false,
    baseCapDisplay: 4,
  ...
  {
    id: "sanctum_purify_box",
    title: "圣域：侵蚀净化所（开箱）",
    description: "每周开箱 2 次，每次默认消耗 80 奥德。",
    category: "副本",
    energyCost: 80,
    goldReward: 0,
    counterTargets: [{ scope: "activities", key: "sanctumPurifyBoxRemaining" }],
    allowComplete: true,
    allowUseTicket: false,
    allowSetCompleted: false,
    baseCapDisplay: 2,
...
export function createDefaultAccount(name: string, id: string): AccountState {
  return {
    ...
    breezePlan: {
      ...
      shopAbyssReplenishAssignedCharacterId: null,
      transformAodeUsed: 0,
    },
  };
}
