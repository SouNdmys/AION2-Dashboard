...
describe("shared/engine refreshCharacterState", () => {
  ...
  it("applies weekly reset and resets weekly stats", () => {
    ...
    character.activities.sanctumRaidChallengeRemaining = 0;
    character.activities.sanctumRaidChallengeBonus = 1;
    character.activities.sanctumRaidBoxRemaining = 0;
    character.activities.sanctumRaidBoxBonus = 1;
    character.activities.sanctumPurifyChallengeRemaining = 0;
    character.activities.sanctumPurifyBoxRemaining = 0;
    ...
    expect(next.activities.sanctumRaidChallengeRemaining).toBe(4);
    expect(next.activities.sanctumRaidChallengeBonus).toBe(0);
    expect(next.activities.sanctumRaidBoxRemaining).toBe(2);
    expect(next.activities.sanctumRaidBoxBonus).toBe(0);
    expect(next.activities.sanctumPurifyChallengeRemaining).toBe(4);
    expect(next.activities.sanctumPurifyBoxRemaining).toBe(2);
